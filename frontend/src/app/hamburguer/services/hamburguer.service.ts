...
export class HamburguersDAOService extends RESTDAOService<any, any> {
  constructor(http: HttpClient) {
    super(http, 'hamburguers', { });
  }
}
@Injectable({
  providedIn: 'root'
})
export class HamburguerViewModelService {
  protected modo: ModoCRUD = 'list';
  protected listado: Array<any> = [];
  protected elemento: any = {};
  protected idOriginal: any = null;
  protected listURL = '/hamburguers';

  constructor(
    protected out: LoggerService,
    protected dao: HamburguersDAOService,
