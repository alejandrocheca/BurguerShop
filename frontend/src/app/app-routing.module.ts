...
import { HamburguerListComponent } from './hamburguer/components/hamburguer.component';
...
const routes: Routes = [
  ...
  { path: 'hamburguers', loadChildren: () => import('./hamburguer/hamburguer.module').then(mod => mod.HamburguerModule)},
